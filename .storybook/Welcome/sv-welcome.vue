<template>
  <main class="welcome">
    <div class="welcome__hero">
      <img
        class="welcome__background-image"
        src="./carbon_bg.png"
        alt="@carbon/vue"
      />
      <h1 class="welcome__heading">
        <span class="nowrap">
          <span class="highlight">Carbon</span> Design system
        </span>
        <span class="nowrap">
          in
      ...
      <div class="bx--row">
        <div class="bx--col-md-2 bx--col-lg-2">
          <ul>
            ...
            <li class="welcome__footer-list-item">
              <a href="https://www.ibm.com/privacy" aria-label="Privacy"
                >Privacy</a
              >
            </li>
            <li class="welcome__footer-list-item">
              <a href="https://www.ibm.com/legal" aria-label="Terms of use"
                >Terms of use</a
              >
            </li>
            <li class="welcome__footer-list-item">
        ...
        <div class="bx--col-md-2 bx--col-lg-2">
          <ul>
            <li class="welcome__footer-list-item">
              <a href="https://medium.com/carbondesign" aria-label="Medium"
                >Medium</a
              >
            </li>
            <li class="welcome__footer-list-item">
              <a href="https://twitter.com/_carbondesign" aria-label="Twitter"
                >Twitter</a
              >
            </li>
            <li class="welcome__footer-list-item">
        ...
        <div
          class="welcome__footer-info bx--offset-lg-2 bx--col-sm-3 bx--col-md-4 bx--col-lg-4"
        >
          <p>
          ...
          <p>
            <span v-if="hasPackageInfo"
              >Last updated {{ packageUpdated }} <br /></span
            >Copyright © 2019 IBM
          </p>
        </div>
      </div>
...
// const packageInfo = Object.values(packageInfoRaw).reduce(
//   (acc, line) => (line.type === 'inspect' ? line : acc),
//   0
// );
...
export default {
  ...
  computed: {
    ...
    packageUpdated() {
      return new Date(packageInfo.data.time.modified).toLocaleDateString(
        undefined,
        {
          month: 'long',
          day: 'numeric',
