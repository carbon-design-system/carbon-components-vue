import { CvCodeSnippetSkeleton } from '../../packages/core/src/';

// More on default export: https://storybook.js.org/docs/vue/writing-stories/introduction#default-export
export default {
  title: 'components/CvCodeSnippet',
  component: CvCodeSnippetSkeleton,
...
const Template = (args, { argTypes }) => ({
  ...
  template: '<cv-codeSnippet-skeleton v-bind="$props" />',
});

export const _CvCodeSnippetSkeleton = Template.bind({});
// More on args: https://storybook.js.org/docs/vue/writing-stories/args
_CvCodeSnippetSkeleton.args = {};
