import { CvCheckboxSkeleton } from '../../packages/core/src/';

// More on default export: https://storybook.js.org/docs/vue/writing-stories/introduction#default-export
export default {
  title: 'components/CvCheckbox',
  component: CvCheckboxSkeleton,
...
const Template = (args, { argTypes }) => ({
  ...
  template: '<cv-checkbox-skeleton v-bind="$props" />',
});

export const _CvCheckboxSkeleton = Template.bind({});
// More on args: https://storybook.js.org/docs/vue/writing-stories/args
_CvCheckboxSkeleton.args = {};
