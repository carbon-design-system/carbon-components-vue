...
- The Vue 2 component uses `v-html` for the placeholder and display values. This no longer works as
  it seems unsafe and could be used as part of a XSS attack. Use the `internal-caption` slot
