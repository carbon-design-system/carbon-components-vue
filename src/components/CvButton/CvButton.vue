...
const props = defineProps({
   ...
   */
  dangerDescriptor: { type: String, default: undefined },
  /**
   ...
   * The a11y role for `<a>`.
   */
  linkRole: { type: String, default: undefined },
  /**
   ...
   */
  ping: { type: String, default: undefined },
  /**
