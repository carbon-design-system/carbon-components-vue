  ...
  <div data-modal
    ...
    <div class="bx--modal-container">
      <div class="bx--modal-header">
        ...
        <button class="bx--modal-close" type="button" data-modal-close :data-modal-primary-focus="initialFocus === 'close'">
          <cv-icon class="bx--modal-close__icon" href="cv(icon--close)" height="10px" width="10px"></cv-icon>
        </button>
      </div>

      <div class="bx--modal-content">
        <slot name="content"><p>Passive modal notifications should only appear if there is an action the user needs to address immediately. Passive modal notifications are persistent on the screen.</p></slot>
      </div>
